...
MODULES = [
    ...
    "test_quantity_items_variants_units.py",
    "test_quantity_warehouses.py",
    "test_quantity_fifo.py",
    "test_quantity_opening_stock.py",
    "test_quantity_purchases.py",
    "test_quantity_sales.py",
    "test_quantity_sale_returns.py",
    "test_quantity_purchase_returns.py",
    "test_quantity_transfers.py",
    "test_quantity_counts_adjustments.py",
